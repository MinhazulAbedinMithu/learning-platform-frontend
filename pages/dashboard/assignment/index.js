          ...
          <table className="table">
            ...
            <tbody className={` text-lg font-semibold text-white`}>
              <tr className="">
                ...
                <td>
                  <button
                    className="bg-teal-900 px-4 py-1 rounded-lg "
                    disabled
                  >
                    Submitted
                  </button>
              ...
              <tr>
                ...
                <td>
                  <button className=" px-4 py-1 text-red-600 rounded-lg border border-red-600 ">
                    Late
                  </button>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <button className="bg-teal-900 px-4 py-1 rounded-lg ">
                    Submit
                  </button>
                </td>
              </tr>
